...
export default function PlaySingle() {
  ...
  return (
    <div className="bg-white border">
      ...
      {/* Testimonials */}
      <div className="flex gap-4 max-w-[65%] py-4 px-14">
        <img
        ...
        <div className="border-b pb-6 mb-4">
          <h3>John Doe</h3>
          <p className="text-xs text-gray-500 mb-6">July 19, 2023</p>
          ...
          <p className="text-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum odio expedita molestiae nisi id placeat laboriosam exercitationem est.</p>
        </div>
      </div>
      <div className="flex gap-4 max-w-[65%] py-4 px-14">
        <img
